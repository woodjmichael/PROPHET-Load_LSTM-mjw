...
HP_DEFINE_SEARCH_SPACE = [(72,192,0.2),(72,192,0.1),(72,192,0.0),(72,96,0.2),(72,120,0.0)] # list or None
...
if os.path.exists(model_opt['model_path']):
    model_opt['model_path'] = model_opt['model_path'] / Path(f'{tic.year-2000}{tic.month}{tic.day}-{tic.hour}{tic.minute}')
...
def test_range(df,model,units=None,n_back=None,dropout=None):
    ...
    #for t in pd.date_range('2017-1-8 0:00','2019-12-28 0:00',freq='1h')[:limit]:
        ...
        _, _, _, new_forecast = lstm_forecaster.main([ini_path],t,df=df,model=model,units=units,n_back=n_back,dropout=dropout)
